    ...
    <main>
      <section className={styles.backgroundWrapper}>
        ...
        <div className="flex flex-col w-full h-full justify-center items-center gap-6">
          <h1 className="whitespace-pre-line font-bold text-3xl -mt-[120px] md:text-6xl">
            Turismo para todos!
          </h1>
          <span className="m-6 md:m-0 max-w-xl md:max-w-3xl lg:max-w-4xl xl:max-w-4xl font-light text-sm lg:text-lg font-sans">
